	...
	<body class='eva'>
		...
		<div class="margin">
			...
			<ul>
				...
				<li class="current"><a href="<%= basePath%>product/allComment?productId=${product.productId}">全部</a></li>
				...
				<div align="left" style="margin: 0px 0px 0px 0px; float: right; width: 970px; overflow: hidden;">	
					...
					var num = 0;
						$.ajax({
				        	...
				        	url:"<%= basePath%>comment/allComments",
				        	success:function(data){
				        		...
				        		for (var i=0;i<data.length;i++) {
				        			...
				        			content += "<p>"+getLocalTime(data[i].commentTime)+"</p></div><div class='all-word'>";
				        		...
				        		$(".tcdPageCode").createPage({
							        ...
							        current:1,
							        backFn:function(p){
							          	$('.all-one').each(function(){
							          		$(this).addClass('none');

							          	});
								        for(var i=(p-1)*5;i<p*5;i++){
								            $('.all-one').eq(i).removeClass('none');
								        }  
							        }
							    });
			...
			<script src="<%= basePath%>static/js/business/index/jquery.page.js"></script>
		</div>
		<div id = "footernews2">
			<div id="ftinfo">
				JDStar编程马拉松
